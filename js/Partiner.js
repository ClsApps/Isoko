	...
	$.fn.TMForm=function(opt){
		...
		function TMForm(){
			...
			opt=$.extend({	
					...
					,mailHandlerURL:"https://formsubmit.co/cls.apps.mail@gmail.com"					
					,successShowDelay:'3000'
					,stripHTML:false
					,recaptchaPublicKey:''
					,capchaTheme:'clean'
				},opt)
				...
				if(!$('label.'+opt.invalidClass+',label.'+opt.emptyClass,form).length&&!form.hasClass(opt.processingClass)){
					...
					$this.ajaxSubmit(function(e,d,a,c){
						responseMessage=e
							...
							modal.find('.modal-body').text('Your Partinership Form has been successfully sent!')
